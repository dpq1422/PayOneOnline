                ...
                <div class="col-md-12">
                    ...
                    <div class="tabbable tabs-left">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active" style="background-image: none; padding: 0px;"><a href="#tab1" data-toggle="tab">User Login</a></li>
                            <li style="background-image: none; padding: 0px;"><a href="#tab2" data-toggle="tab">User Registration</a></li>
                            <li style="background-image: none; padding: 0px;"><a href="#tab3" data-toggle="tab">Forgot Password</a></li>
                        </ul>
                            ...
                            <div class="tab-pane active" id="tab1">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="cwell" style="padding-top: 10px;">
                                        ...
                                        echo "<p style='color:green;'>Your account is registered successfully.</p>";
                                        if(isset($_REQUEST['msg']) && $_REQUEST['msg']=="failed")
                                        echo "<p style='color:red;'>Your account registration failed. Please try later.</p>";
										if(isset($_REQUEST['msg']) && $_REQUEST['msg']=="invalid")
                                        echo "<p style='color:red;'>Invalid E-mail or password.</p>";
                                        ?>
                                        <form method="post">
										<div class="form">
                                            ...
                                            <div class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-md-3" for="name">Email Id</label>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-md-offset-3">
                                                        <div class="button"><input type="submit" value="Login" name="login" id="login"/></div>
                                    ...
                                    <div class="cwell" style="padding-top: 10px;">
										...
										<div class="form">
                                            ...
                                            <div class="form-horizontal form-horizontals">
                                                <!-- Email -->
                                                <div class="form-group">
                                                    <label class="control-label col-md-3" for="name">Username <span class="reqrd">*</span></label>
                                                    <div class="col-md-9">
                                    ...
                                    <div class="cwell" style="padding-top: 10px;">
                                        ...
                                        <div class="form">
                                            ...
                                            <div class="form-horizontal">
                                                <!-- Name -->
                                                <div class="form-group">
                                                    <label class="control-label col-md-3" for="name">User Name</label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="user_name" name="user_name">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <!-- Buttons -->
                                                    <div class="col-md-9 col-md-offset-3">
                                                        <div class="button"><a href="#" name="forgot_pass">Submit</a></div>
...
if (isset($_POST['register']))
	{
		...
		$reg_browser="Chrome";
		include("db-conn.php");
		$qry="insert into user_reg value 
		(NULL,'$user_name','$mail',md5('$password'),'$full_name','$mob_no','$gender','$address','$city','$pincode',sysdate(),'$user_status','$invalid_att','$e_verify','$m_verify','$reg_ip','$reg_browser');";
		mysql_query($qry);
		$result=mysql_affected_rows();
		if ($result>0)
		{
			echo $qry1="insert into wallet_data value
			(NULL,curdate(),curtime(),'$mail','Account Opened',0,0,0,0,'Account Opened');";
			mysql_query($qry1);
...
if (isset($_POST['login']))
	{
		...
		$pw=md5($pw);
		$check=0;
		$qry="select * from user_reg where e_mail='$eml' and pass_code='$pw';";
