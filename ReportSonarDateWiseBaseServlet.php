            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						$total_records=rd1_count();
						$result_rd=rd1_show();
						$qr="&s1=$s1&s2=$s2&s3=$s3&s4=$s4&s5=$s5&search=search";
						$i=0;
						?>
                    	<div class="box-head">
                        	<h3>SONAR REPORT DATE WISE (Wallet Balance / Member Registrations / Wallet Requests / Tickets Raised) <span class="w3-right w3-blue w3-center badges"><?php echo $total_records;?></span></h3>
                        </div>
                        <div class="w3-responsive">
                        	<table class="w3-table-all" id="myTable" style="border:none;">
                            	<tr class="w3-blue">
                                    <th>Date</th>
                                    <th class='w3-text-right'>Op.Bal</th>
                                    <th class='w3-text-right'>Wal.Upd</th>
                                    <th class='w3-text-right'>Wal.Trf</th>
                                    <th class='w3-text-right'>Cl.Bal</th>
                                ...
                                <tr>
                                	...
                                	<td class='w3-text-right'><?php echo $rs_rd['opening_balance'];?></td>
                                    <td class='w3-text-right'><?php echo $rs_rd['wallet_received'];?></td>
                                    <td class='w3-text-right'><?php echo $rs_rd['wallet_transfer'];?></td>
                                    <td class='w3-text-right'><?php echo $rs_rd['closing_balance'];?></td>
