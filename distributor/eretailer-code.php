...
if($result4==1)
{
	...
	mysql_query("insert into child_employee_retailer values (NULL, '$last_id','$user_id')");
	...
	header("location:set-mt-margine.php?uid=$last_id");
}
else
{
	header("location:eretailer.php?msg=retailer-registration-fail");
}
