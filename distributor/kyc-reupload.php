									...
									<div class="panel-body panel-primary text-center">
										<form action="kyc-reupload-code.php" method="post" enctype="multipart/form-data" onsubmit="return validateKyc()">
											<table>
												<tr>
													<td align="left" width="200">Business Name</td>
													<td align="left"><input value="<?php echo $kbiz_name;?>" required size="35" name="biz_name" /></td>
													<td width="100"></td>	
												...
												<tr>
													...
													<td width="75"></td>	
													<td align="left">Date of Birth</td>
													<td align="left"><input type="date" required value="<?php echo $kdob;?>" name="dob" size="35" /></td>
												</tr>
												<tr><td>&nbsp;</td></tr>
												<tr>
