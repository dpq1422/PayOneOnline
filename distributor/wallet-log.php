							...
							<div class="col-md-12">
								<div class="panel panel-primary">
									...
									<?php
										...
										$cond="";
										if($t1!="")
											$cond=" $cond and user_id2='$t1' ";
										if($t2!="")
											$cond=" $cond and wallet_date='$t2' ";
									?>
										<form method="post">
										Search by 
										<input size="20" name="t1" id="t1" value="<?php echo $t1;?>" placeholder="User ID"/>
										<input type="date" name="t2" id="t2" value="<?php echo $t2;?>" placeholder="Date"/>
									...
									<?php 
									$a=$b=$c=$d=0;
										$query="SELECT * FROM child_wallet_remain where user_id=$user_id  $cond order by wallet_id desc limit 0,100";
									...
									?>
												<tr <?php echo $style;?>>
													...
													<td><?php echo $rs['user_id2'];?><br>(<?php echo show_my_uname($rs['user_id2']);?>)</td>
