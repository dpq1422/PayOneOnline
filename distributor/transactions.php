							...
							<div class="col-md-12">
								...
								<!--<form method="post">
									...
									<div class="panel-body panel-primary text-left">
										Search by 
										<input type='number' size="30" value="<?php echo $s1;?>" placeholder="User ID" id='a' name='a' onkeyup='clearother(1)' />
									...
									<div class="panel-body panel-primary text-center">
											...
											<tbody>
												...
												$query="SELECT * FROM main_transaction_mt where  user_id in(select user_id from child_user where $field1='$user_type' and $field2='$user_id') order by eko_transaction_id desc limit 0,50";
