								...
								<div class="panel panel-primary">
									...
									?>
										...
										while($rs_r = mysql_fetch_assoc($result_r)) 
										{
											...
											$payment_mode="Cash Value";
											else if($payment_mode==8)
											$payment_mode="Advance Value";
										...
										?>
											<table>
												...
												<tr><td>&nbsp;</td></tr>
												<tr>
													<td align="left">Requested Amount<br><input required name="deposit_amount" readonly value="<?php echo $deposit_amount; ?>"  size="30" /></td>
													<td width="75"></td>
													<td align="left">Payment Mode<br><input readonly value="<?php echo $payment_mode; ?>"  size="30" /></td>
													<td width="75"></td>
													<td align="left">Remarks<br><?php echo $remarks; ?></td>
												</tr>
												<tr><td>&nbsp;</td></tr>
												<tr>
													<td align="left">
