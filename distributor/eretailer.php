							...
							<div class="col-md-12">
								<div class="panel panel-primary">
									...
									<div class="panel-body panel-primary text-center">
										<form action="eretailer-code.php" method="post" onsubmit="return validateRetailer()">
											<table>
												<tr>
												...
												<tr><td>&nbsp;</td></tr>
												<tr>
													<td align="left"><input type="hidden" name="HierarchyName" value="11"/></td>
													<td width="75"></td>
													<td align="left"><input type="hidden" name="ParentHierarchyName" value="<?php echo $isemp_type;?>"/></td>
													<td width="75"></td>
													<td align="left"><input type="hidden" name="ParentNameByHierarchy" value="<?php echo $isemp_under;?>"/></td>
												</tr>
												<tr><td>&nbsp;</td></tr>
												<tr>
