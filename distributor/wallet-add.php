							...
							<div class="col-md-12">
								<div class="panel panel-primary">
									...
									if($search!="")
									{
										...
										//$query4a="select * from child_user where user_id='$search' and $field1='$user_type' and $field2='$user_id';";
										$query4a="select * from child_user where user_id='$search' and user_id not in(100000,100005) and user_type!=0;";
									...
									<div class="panel-body panel-primary text-center">
										<table>
											...
											?>
											<tr>
												<td colspan="5" align="left"><b style="color:red;font-weight:normal;">Your Wallet Balance is less than transferring amount.</b></td>
											</tr>
											<tr><td>&nbsp;</td></tr>
											<?php
											}
											...
											?>
											<tr>
												<td colspan="5" align="left"><b style="color:red;font-weight:normal;">You are not authorised to transfer this user id <?php echo $search; ?></b></td>
											</tr>
											<tr><td>&nbsp;</td></tr>
											<?php
											}
											...
											<tr><td>&nbsp;</td></tr>
											<tr>
												<!--<td align="left">City<br><?php echo $scitys;?></td>
												<td width="75"></td>-->
											...
											<tr><td>&nbsp;</td></tr>
											<form action="wallet-add-code.php" method="post" onsubmit="return validateAmount()">
											<tr>
												<td align="left">Amount to Deposit<br><input type="hidden" name="uid" value="<?php echo $sids;?>" />
