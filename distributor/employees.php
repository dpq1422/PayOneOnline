							...
							<div class="col-md-12">
								<div class="panel panel-primary">
									...
									<?php 
										...
										$query="SELECT * FROM child_user where user_type=2 $cond and user_id in(select employee_uid from child_employee where under_uid='$user_id') order by user_status asc,user_id desc";
