...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body><!--oncontextmenu="return false"-->
		...
		$field_name1="hierarchy_".$isemp_type."_no";
		$field_name2="hierarchy_".$isemp_type."_id";
		$query="SELECT * FROM child_user where $field_name1=$isemp_type and $field_name2=$isemp_under and user_type=11 $cond and user_id in(select retailer_uid from child_employee_retailer where under_uid='$user_id') order by user_status asc,hierarchy_1_no,hierarchy_2_no,hierarchy_3_no,user_type";
