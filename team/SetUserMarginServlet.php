                            ...
                            <table class="w3-table-all" id="myTable" style="border:none;">
								...
								while($margin_row=mysql_fetch_array($margin_result))
								{
									...
									if($amt_25000==0)
										$amt_25000="-";
									$vary=0.50;
									if($usertype==12 && $logged_user_type!=2)
										$vary=0.50;
									
									$mmg=show_mt_margin($logged_user_id, $source_id, $payment_method);
									
									$min=$max=array();
									if($usertype==2)//abhi//kd
									{
										$min=array(show_max(7.5,$mmg[0]),show_max(9,$mmg[1]),show_max(9,$mmg[2]),show_max(9,$mmg[3]),show_max(9,$mmg[4]));
										$max=array(25,30,35,35,35);
									}
									else if($usertype==3)//master
									{
										//$min=array(show_max(7.5,$mmg[0]),show_max(9,$mmg[1]),show_max(12.5,$mmg[2]),show_max(12.5,$mmg[3]),show_max(12.5,$mmg[4]));
										$min=array(show_max(7.5,$mmg[0]),show_max(9,$mmg[1]),show_max(9,$mmg[2]),show_max(9,$mmg[3]),show_max(9,$mmg[4]));
										$max=array(14,14,14,14,14);
									}
									else if($usertype==4)//super
									{
										//$min=array(show_max(8,$mmg[0]),show_max(10,$mmg[1]),show_max(13,$mmg[2]),show_max(13,$mmg[3]),show_max(13,$mmg[4]));
										$min=array(show_max(7.5,$mmg[0]),show_max(9,$mmg[1]),show_max(9,$mmg[2]),show_max(9,$mmg[3]),show_max(9,$mmg[4]));
										$max=array(18,18,18,18,18);
									}
									else if($usertype==5)//distributor
									{
										//$min=array(show_max(9,$mmg[0]),show_max(11,$mmg[1]),show_max(14,$mmg[2]),show_max(14,$mmg[3]),show_max(14,$mmg[4]));
										$min=array(show_max(7.5,$mmg[0]),show_max(9,$mmg[1]),show_max(9,$mmg[2]),show_max(9,$mmg[3]),show_max(9,$mmg[4]));
										$max=array(20,20,20,20,20);
									}
									else if($usertype==12)//retailer
									{
										$min=array(show_max(7.5,$mmg[0]),show_max(9,$mmg[1]),show_max(9,$mmg[2]),show_max(9,$mmg[3]),show_max(9,$mmg[4]));
										$max=array(25,30,35,35,35);
									}
