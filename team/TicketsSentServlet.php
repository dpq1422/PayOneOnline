...
function abcd(row_no)
{
	...
	$.ajax({
		type: "POST",
		url: "AjaxTicketSentUpdateServlet",
            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						?>
                    	<div class="box-head">
                        	<h3>LIST OF TICKETS <span class="w3-right w3-blue w3-center badges"><?php echo $total_records;?></span></h3>
                        </div>
										...
										<table class="wh">
											<tr>
												<td width="35%"valign="top">
													<p><strong>YOUR REMARKS:-</strong> <?php echo $user_row['user_remarks'];?></p>
													<p><strong>YOUR TIME:-</strong> <?php echo $user_row['user_updates'];?></p>
												</td>
												<td width="35%" valign="top">
