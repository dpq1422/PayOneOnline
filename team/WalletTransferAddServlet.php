                	...
                	<div class="table-box wh w3-left">
						...
						if(isset($_POST['TransferWallet']))
						{
							...
							if($tpin==$logged_tpin)
							{
								...
								if($amount>0)
								{
									transfer_user_to_user($logged_user_id, $touser, $amount, $remarks, $remarks_admin);
								}
								echo "<script>window.location.href='WalletHistoryUserServlet';</script>";
							}
							else
							{
                        ...
                        <form class="wh w3-left" method="post">
                        	<div class="w3-row-padding w3-margin-bottom">                               
                                ...
                                <div class="w3-col m6 l4 w3-margin-top">
                                	<label>USER ID</label>
                                	<input name="uid" maxlength="6" onclick="hide_det()" id="uid" value="<?php echo $xuid;?>" onkeyup="check_value()" type="number" placeholder="USER ID" class="w3-input w3-border w3-round"> 
