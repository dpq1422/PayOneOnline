            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
                    	<div class="box-head">
                        	<h3>UPLOAD BANK STATEMENT FOR AUDIT</h3>
                        </div>
                        <form class="wh w3-left">
                        	<div class="w3-row-padding w3-margin-bottom">
                            	...
                            	<div class="w3-col m6 l4 w3-margin-top">
                                	...
                                	<input type="file" placeholder="Name" class="w3-input w3-border w3-round">                                    
                                </div>  
                                   
                                <div class="w3-col m12 w3-margin-top w3-right-align">
                                	<a class="w3-button w3-round w3-blue" onclick="document.getElementById('id01').style.display='block'">UPLOAD</a>
                                </div>                              
                        	</div>
                        </form>
                    </div>
      ...
      <div class="w3-container w3-center">
        ...
        <div class="w3-container" style="margin-bottom:10px;">
            <div class="w3-bar w3-center">
                <a href="AuditUploadBankStatementProcessServlet" class="w3-button w3-blue w3-round">Yes</a>
