                        	...
                        	<ul>
								...
								while($service_row=mysql_fetch_array($service_result))
								{
									...
									else if($sid==102)
									{
										...
										<button onclick='location.href=\"SetServiceRcMarginServlet\";' class='w3-button w3-blue w3-round'>Update Commission for Team</button>";
									}
									else if($sid==103)
									{
										...
										<button onclick='location.href=\"SetServiceDthMarginServlet\";' class='w3-button w3-blue w3-round'>Update Commission for Team</button>";
									}/*
									else if($sid==105)
									{
									...
									else if($sid==106)
									{
										...
										<button onclick='location.href=\"SetServicePostpaidMarginServlet\";' class='w3-button w3-blue w3-round'>Update Commission for Team</button>";
									}
