            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						$total_records=show_operators_count($cond);
						$operator_result=show_operators_data($cond, $start_from, $num_rec_per_page);
						$qr="";//"&s1=$s1&s2=$s2&s3=$s3&s4=$s4&search=search";
						$i=0;
						?>
                    	<div class="box-head wh w3-left">
                                <h3 class="wh w3-left">LIST OF operators <span class="w3-right w3-blue w3-center badges"><?php echo $total_records;?></span></h3>
                        </div>
                        <div class="table-div wh w3-left">
                        	<ul>
								...
								while($operator_row=mysql_fetch_array($operator_result))
								{
									...
									$operator_status=$operator_row['operator_status'];
									$st_link="";
									if($operator_status==1)
									{
										$operator_status="<b class='w3-text-green'>Active</b>";
										$st_link="<button class='w3-button w3-red w3-round'>Mark As Block</button>";
									}
									else if($operator_status==0)
									{
										$operator_status="<b class='w3-text-red'>Blocked</b>";
										$st_link="<button class='w3-button w3-green w3-round'>Mark As Active</button>";
									}
								?>
                                <li>
                                	<span><?php echo $operator_row['operator_id'];?></span>
                                    <span><?php echo show_service_name($operator_row['service_id']);?></span>
                                    <span><?php echo $operator_row['operator_name'];?></span>
                                    <span><?php echo $operator_status;?></span>
