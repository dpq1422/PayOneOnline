                        ...
                        <div class="table-div wh w3-left">
                        	<ul>
								...
								while($service_row=mysql_fetch_array($service_result))
								{
									...
									if($service_type==1)
										$service_type="<b class='w3-text-blue'>Non KYC Service</b>";
									else if($service_type==2)
										$service_type="<b class='w3-text-green'>KYC Service</b>";
									else if($service_type==3)
										$service_type="<b class='w3-text-orange'>Upcoming Service</b>";
								?>
                                <li>
