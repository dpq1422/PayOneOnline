            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
                    	<div class="box-head">
                        	<h3>AUDIT UNIDENTIFIED BANK TXNS - CREDIT RECORDS <span class="w3-right w3-blue w3-center badges">122</span></h3>
                        </div>
                        <div class="table-div wh w3-left">
                        	<ul>
                            	<li class="table-div-head">
                                	<span>ID</span>
                                    <span>BANK NAME</span>
                                    <span>SbiBranceCode</span>
                                    <span>IciciTxnNo</span>
                                    <span>Cheque No. / Description</span>
                                    <span>CR</span>
                                    <span>BALANCE</span>
                                    <span>REQ ID</span>
                                    <span>CLIENT ID</span>
