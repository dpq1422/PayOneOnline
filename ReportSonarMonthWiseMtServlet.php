            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						$total_records=md2_count();
						$result_md=md2_show();
						$qr="&s1=$s1&s2=$s2&s3=$s3&s4=$s4&s5=$s5&search=search";
						$i=0;
						?>
                    	<div class="box-head">
                        	<h3>SONAR REPORT MONTH WISE (Account Verification / Money Transfer) <span class="w3-right w3-blue w3-center badges"><?php echo $total_records;?></span></h3>
                        </div>
                        <div class="w3-responsive">
                        	<table class="w3-table-all" id="myTable" style="border:none;">
                            	<tr class="w3-blue">
                                    <th>Date</th>
                                    <th class='w3-text-right'>MT</th>
                                    <th class='w3-text-right'>AV</th>
                                    <th class='w3-text-right'>Charges</th>
                                    <th class='w3-text-right'>Charged</th>
								...
								{
									$a+=$rs_rd['transfer_amount'];
									$b+=$rs_rd['transfer_unit'];
									$c+=$rs_rd['verification_amount'];
									$d+=$rs_rd['verification_unit'];
									$e+=$rs_rd['charges'];
									$f+=$rs_rd['charged']+$rs_rd['charged_later'];
									$g+=$rs_rd['noti'];
									$h+=$rs_rd['succ'];
									$i+=$rs_rd['inpro'];
									$j+=$rs_rd['rpsrc'];
                                ...
                                <tr>
                                    ...
                                    <td class='w3-text-right'><?php echo $rs_rd['transfer_amount']." <br>(".$rs_rd['transfer_unit'].")";?></td>
                                    <td class='w3-text-right'><?php echo $rs_rd['verification_amount']." <br>(".$rs_rd['verification_unit'].")";?></td>
                                    <td class='w3-text-right'><?php echo $rs_rd['charges'];?></td>
                                    <td class='w3-text-right'><?php echo $rs_rd['charged']+$rs_rd['charged_later'];?></td>
                            	...
                            	<tr class="w3-green">
                                    <th>GRAND TOTAL</th>
                                    <th class='w3-text-right'><?php echo $a." <br>($b)";?></th>
                                    <th class='w3-text-right'><?php echo $c." <br>($d)";?></th>
                                    <th class='w3-text-right'><?php echo $e;?></th>
                                    <th class='w3-text-right'><?php echo $f;?></th>
                                    <th class='w3-text-right'><?php echo $g;?></th>
                                    <th class='w3-text-right'><?php echo $h;?></th>
                                    <th class='w3-text-right'><?php echo $i;?></th>
                                    <th class='w3-text-right'><?php echo $j;?></th>
                                    <th class='w3-text-right'><?php echo $k;?></th>
                                    <th class='w3-text-right'><?php echo $l;?></th>
                                    <th class='w3-text-right'><?php echo $m;?></th>
                                    <th>&nbsp;</th>
                                </tr>
                            </table>
                        </div>
