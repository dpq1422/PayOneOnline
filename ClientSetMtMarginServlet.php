            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						?>
                    	<div class="box-head">
                        	<h3>Set Money Transfer Charges for Client</h3>
                        </div>
                        <form class="wh w3-left" action="" method="post">
							...
							<div class="w3-responsive">
								...
								?>
									<tr>
									  <td colspan='7' class='w3-right-align'><a class="w3-button w3-round w3-blue" onclick="document.getElementById('id01').style.display='block'">Update Client MT Charges</a>
