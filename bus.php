...
<title>Bus Booking :: <?php echo $site_link;?></title>
            ...
            <div class="w3-row-padding">
                <div class="w3-col l3 m3 w3-padding-16">
                    <div class="left-menu wh w3-left">
                    	...
                    	<ul>
							...
							<li><a href="flight-booking.php">Flight Booking</a></li>
							<li><a href="railway-reservation.php">Railway Reservation</a></li>
							<li><a class="active-arrow" href="bus.php">Bus Booking</a></li>
                        </ul>
                    </div>
                </div>
                <div class="w3-col l9 m9 w3-padding-16">
                    <div class="right-contact wh w3-left show-tab">
                    	...
                    	<h2 class="w3-text-deep-orange">Bus Booking</h2>
						<img src="img/comming-soon.png" class="w3-pad" height="150" align="right" />
                        <p class="w3-margin-top w3-justify">
You can book bus tickets of more than 1000 routes of busses all over India. We are continuously adding more and more routes in bus booking to expand our network. With our platform, No investment is required for open your own bus booking agency, just search, book and done! 
Get high commissions on each bus booking.
</p>
						<div class="money-feature w3-margin-top wh w3-left">
						    <p>
                                <script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
                        ...
                        <div class="money-feature w3-margin-top wh w3-left">
                        	<h6><strong>Some features of our bus booking service are -</strong></h6>
                        	<ul>
                            	<li><p>1000+ routes supported.</p></li>
                                <li><p>High commission.</p></li>
                                <li><p>Seat layout of buses to select seats.</p></li>
                                <li><p>Supports for AC, Non-AC, Volvo, sleeper buses and cabs.</p></li>
