...
<title>Pan Card Services :: <?php echo $site_link;?></title>
            ...
            <div class="w3-row-padding">
                <div class="w3-col l3 m3 w3-padding-16">
                    <div class="left-menu wh w3-left">
                    	...
                    	<ul>
							...
							<li><a href="dth-subscriptions.php">DTH Subscriptions</a></li>
							<li><a href="bill-payments.php">Bill Payments</a></li>
							<li><a class="active-arrow" href="pan-card.php">Pan Card Services</a></li>
							<li><a href="aeps.php">AEPS</a></li>
							<li><a href="mpos-devices.php">mPOS / POS Devices</a></li>
							<li><a href="prepaid-cards.php">Prepaid Cards</a></li>
							<li><a href="flight-booking.php">Flight Booking</a></li>
                ...
                <div class="w3-col l9 m9 w3-padding-16">
                    <div class="right-contact wh w3-left show-tab">
                    	...
                    	<h2 class="w3-text-deep-orange">PAN Card Services</h2>
                        <p class="w3-margin-top w3-justify">
We support PAN card services through UTI. We invite partners to become PAN Service Agents (PSA). To enable this feature, the agent just need to submit the KYC from the agent panel and register. UTI username is created after KYC verification only. Once registered, you can purchase coupon and use the same on the UTI website directly for providing PAN services.   </p>
						<div class="money-feature w3-margin-top wh w3-left">
						    <p>
                                <script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
                                <!-- Ad Responsive -->
                        ...
                        <div class="money-feature w3-margin-top wh w3-left">
                        	<h6><strong>Some features of PAN services -</strong></h6>
                        	<ul>
                            	<li><p>Register for PAN services and get username.</p></li>
                                <li><p>Standard PAN Application fee.</p></li>
                                <li><p>PAN processing directly from UTI website.</p></li>
                                <li><p>Add coupons to process PAN using same agent account. </p></li>
                            </ul>
