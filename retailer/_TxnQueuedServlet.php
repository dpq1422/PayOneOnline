            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						/**************************/
						$s1=$s2=$s3=$s4=$s5="";
						$cond=" where 1=1 and user_id='$logged_user_id' and order_status in(-2) ";
						...
						?>
                    	<div class="box-head">
                        	<h3>QUEUED TRANSACTIONS - Domestic Money Transfer <span class="w3-right w3-blue w3-center badges"><?php echo $total_records;?></span></h3>
                        </div>
                                	...
                                	<div class="address<?php echo $i;?> inner-add wh w3-left">
										...
										<table width='100%'>
											...
											<tr>
												...
												<td><?php echo $user_row['amount'];?></td>
												<td></td>
												<td><?php echo $user_row['com_charged'];?></td>
