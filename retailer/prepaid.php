	...
	<head>
		...
		function checkRech()
		{
			...
			if(isSize(mobile,10,10)==1)
				err+="\n - Mobile number size should be 10 digits.";
			if(operator=="")
	...
	<div id="form1">
		...
		<div class="wrapper vertical-sidebar" id="full-page">
		 ...
		 <?php
			...
			else if($mob!="" && $opr!="" && $cir!="" && $amt!="")
			{
				$desc="Prepaid, $mob, $opr, $cir, $amt";
				$operator_id=0;
				$sadmin_chg=0;
				$ret_chg=0;
				$dist_chg=0;
				...
				$qry1="select * from all_operator where service_type_id=102 and api_code_1='$opr'";
				...
				if($msg1=="" && $msg2=="")
				{
					...
					if($chk_record==0)
					{
						...
						value('$user_id', '$mob', '$opr', '$cir', '$amt', '$ret_amt', '$datetime_time', '$datetime_time', '$main_ip', '$rcsource', '$rctype', '$retailer_id_new', '$ret_chg', '$dist_id_new', '$dist_chg', '$sd_id_new', '$sd_chg', '$admin_id_new', '$admin_chg', '$server_st');";
						mysql_query($qry5);				
						...
						$call_url="http://mentor-india.co.in/api-payoneonline.com/rc_ap_live.php";
						$url = "$call_url" . "?";
				...
				<div class="col s12 m12 l6" id="addBeneficiary" >
					<div class="card project-stats">
						<div class="card-content">
							<h5 style="float:left;"><i class="fa fa-mobile fa-1x"></i> Recharge Mobile </h5>
								...
								<form method="post" id="frmRechargeMobile">
									...
									<div class="input-field col l8 m12 s12 offset-l2">
										<select class="chosen" name="operator" required id="operator">
											...
											<?php
											$query_bnk="SELECT * FROM all_operator where service_type_id=102";
									...
									<div class="input-field col l8 m12 s12 offset-l2">
										<select class="chosen" name="circle" required id="circle">
											<option value="">Select Circle</option>
											<?php
											$query_bnk="SELECT * FROM all_state where api_code_1!='0' order by api_code_1";
											$result_bnk=mysql_query($query_bnk);
											while($rs_bnk = mysql_fetch_assoc($result_bnk))
											{	
												$bnk_name=$rs_bnk['api_code_1'];
											?>
											<option value="<?php echo $bnk_name;?>"><?php echo $bnk_name;?></option>
											<?php
											}												
											?>
										</select>
