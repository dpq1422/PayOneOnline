            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						/**************************/
						$s1=$s2=$s3=$s4="";
						$cond=" where 1=1 and mrc_status=-1 and type in(3,4,5) ";
						...
						?>
                    	<div class="box-head">
                        	<h3>QUEUED TRANSACTIONS - Prepaid Mob Recharge, DTH Recharge, PostPaid Mob Bill <span class="w3-right w3-blue w3-center badges"><?php echo $total_records;?></span></h3>
                        </div>
