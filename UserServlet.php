                        ...
                        <form class="wh w3-left">
                        	<div class="w3-row-padding w3-margin-bottom">  
                                ...
                                <div class="w3-col m6 l4 w3-margin-top" style="position:relative">
                                	...
                                	<span class="abc">(must have at least 1 letter, 1 num, 1 special character)</span>
                                ...
                                <div class="w3-col m6 l4 w3-margin-top gender-w">
                                    ...
                                    <div>
                                        <input value="1" name="deps[]" disabled class="w3-check" type="checkbox">
                                        <label>Master</label>
                                    </div>
                                    <div>
                                        <input value="2" name="deps[]" disabled class="w3-check" type="checkbox">
                                        <label>Setup</label>
                                    </div>
                                    <div>
                                    	<input value="3" name="deps[]" disabled class="w3-check" type="checkbox">
                                    	<label>Client</label>
                                    </div>
                                    <div>
                                        <input value="4" name="deps[]" checked class="w3-check" type="checkbox">
                                        <label>Wallet</label>
                                    </div>
                                    <div>
                                        <input value="5" name="deps[]" checked class="w3-check" type="checkbox">
                                        <label>Transactions</label>
                                    </div>
                                    <div>
                                        <input value="6" name="deps[]" checked class="w3-check" type="checkbox">
                                        <label>Support</label>
                                    </div>
                                    <div>
                                        <input value="7" name="deps[]" class="w3-check" type="checkbox">
                                        <label>Audit</label>
                                    </div>
                                    <div>
                                        <input value="8" name="deps[]" class="w3-check" type="checkbox">
                                        <label>Report</label>
                                    </div>
                                </div> 
