...
function check_values() {
	...
	else
	{
		...
		$("#error-message").html("Do you want to update Company Info?");
		$("#ButtonFirst").hide();
		$("#ButtonSecond").show();
		$("#ViewServlet").show();
		$("#error-box").show();
                	...
                	<div class="table-box wh w3-left">
                        ...
                        <form class="wh w3-left" method="post" onsubmit="return check_values()">
                        	<div class="w3-row-padding w3-margin-bottom">  
                                ...
                                <div class="w3-col m6 l4 w3-margin-top">
                                	<label>Website</label>
                                	<input type="text" name="cweb" id="cweb" placeholder="Website" class="w3-input w3-border w3-round" value="<?php echo $company_row['web_site'];?>">                                    
                                </div>
  ...
  <div id="error-box" class="w3-modal">
    <div class="w3-modal-content w3-animate-zoom w3-card-4 w3-round list-pop">
      ...
      <div class="w3-container w3-center">
      	<p id="error-message">Do you want to update Company Info?</p>
      </div>  
