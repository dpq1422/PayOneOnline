            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						$total_records=show_welcomemessages_count($cond);
						$welcomemessage_result=show_welcomemessages_data($cond, $start_from, $num_rec_per_page);
						$qr="";//"&s1=$s1&s2=$s2&s3=$s3&s4=$s4&search=search";
						$i=0;
						?>
                    	<div class="box-head">
                        	<h3>List of Welcome Messages for Branding <span class="w3-right w3-blue w3-center badges"><?php echo $total_records;?></span></h3>
                        </div>
                        <div class="table-div wh w3-left">
                        	<ul>
								...
								while($welcomemessage_row=mysql_fetch_array($welcomemessage_result))
								{
									...
									$welcomemessage_status=$welcomemessage_row['welcome_status'];
									$st_link="";
									if($welcomemessage_status==1)
									{
										$welcomemessage_status="<b class='w3-text-green'>Active</b>";
										$st_link="<a href='AjaxBrandingWelcomeMessageStop' class='w3-button w3-red w3-round'>Stop</a>";
									}
									else if($welcomemessage_status==0)
									{
										$welcomemessage_status="<b class='w3-text-red'>Blocked</b>";
									...
									{
										$welcomemessage_type="Image";
										$welcomemessage="<img src='".$welcomemessage_row['welcome_file']."'/>";
									}
									else if($welcomemessage_type==0)
									{
										$welcomemessage_type="Text";
										$welcomemessage=$welcomemessage_row['welcome_message'];
									}
									
									$message_for=$welcomemessage_row['message_for'];
									if($message_for==0)
									{
										$message_for="All Users";
									}
									else if($message_for==1)
									{
										$message_for="Admin Users";
									}
									else if($message_for==-1)
									{
										$message_for="Office Users";
									}
								?>
                                <li>
                                	<span><?php echo $welcomemessage_row['welcome_id'];?></span>
                                    <!--<span><?php echo $message_for;?></span>-->
                                    <span><?php echo $welcomemessage_row['welcome_name'];?></span>
                                    <!--<span><?php echo $welcomemessage_type;?></span>
                                    <span><?php echo $welcomemessage_row['from_date'];?></span>
                                    <span><?php echo $welcomemessage_row['from_to'];?></span>-->
                                    <span><?php echo $welcomemessage_status;?></span>
                                    <span><a onclick="expand('<?php echo $i;?>')" class="add-icon add<?php echo $i;?>"></a></span>
                                </li>
                                <li>
                                	<div class="address<?php echo $i;?> inner-add wh w3-left">
                                        <p><strong>Welcome Message :- </strong>
										<br><br><?php echo $welcomemessage;?></p>
