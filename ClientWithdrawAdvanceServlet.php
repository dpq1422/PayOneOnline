                	...
                	<div class="table-box wh w3-left">
                        ...
                        <form class="wh w3-left" method="post">
                        	<div class="w3-row-padding w3-margin-bottom">  
                                ...
                                <div class="w3-col m6 l4 w3-margin-top">
                                	<label>Withdraw Advance Amount</label>
                                	<input type="text" id="amount" name="amount" placeholder="Withdraw Advance Amount" class="w3-input w3-border w3-round">                              
                                </div>
                                ...
                                <div class="w3-col m12 w3-margin-top w3-right-align">
                                	...
                                	<a class="w3-button w3-round w3-blue" onclick="check_values()">Withdraw Advance</a>
                                </div>                                    
                        	</div>
                        </form>
                    </div>
