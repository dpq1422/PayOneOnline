                        ...
                        <form class="wh w3-left">
                        	<div class="w3-row-padding w3-margin-bottom"> 
                            	...
                            	<div class="w3-col m6 l4 w3-margin-top">
                                	...
                                	<input type="text" placeholder="Bank Name" class="w3-input w3-border w3-round">                                    
                                </div>
                                
                                <div class="w3-col m6 l4 w3-margin-top">
                                	<label>Account Name</label>
                                	<input type="text" placeholder="Account Name" class="w3-input w3-border w3-round">                                    
                                </div>
                                
                                <div class="w3-col m6 l4 w3-margin-top">
                                	<label>Account No.</label>
                                	<input type="text" placeholder="Account No." class="w3-input w3-border w3-round">                                    
                                </div>
                                
                                <div class="w3-col m6 l4 w3-margin-top">
                                	<label>Branch Name</label>	
                                	<input type="text" placeholder="Branch Name" class="w3-input w3-border w3-round">
                                </div>
                                
                                <div class="w3-col m6 l4 w3-margin-top">
                                	<label>IFSC Code</label>	
                                	<input type="text" placeholder="IFSC Code" class="w3-input w3-border w3-round">
                                </div>
      ...
      <div class="w3-container w3-center">
        ...
        <div class="w3-container" style="margin-bottom:10px;">
            <div class="w3-bar w3-center">
                <a href="BanksServlet" class="w3-button w3-blue w3-round">Yes</a>
