...
<title>Money Transfer :: <?php echo $site_link;?></title>
            ...
            <div class="w3-row-padding">
                <div class="w3-col l3 m3 w3-padding-16">
                    <div class="left-menu wh w3-left">
                    	...
                    	<ul>
							<li><a class="active-arrow" href="money-transfer.php">Money Transfer</a></li>
							<li><a href="recharge.php">Recharge</a></li>
							<li><a href="dth-subscriptions.php">DTH Subscriptions</a></li>
							<li><a href="bill-payments.php">Bill Payments</a></li>
							<li><a href="pan-card.php">Pan Card Services</a></li>
...
We are providing Domestic Money Transfer (DMT) services in partnership with banking institutions. Our Money Transfer system is outcome of detailed study and continuous up gradation for over 6 years. Our Money Transfer platform is one of the very few in India which supports transactions through Android app. We support multiple transaction system for each customer with separate banks giving a total non-KYC customer transaction limit of Rs 50,000/- per month.</p>
                        ...
                        <div class="money-feature w3-margin-top wh w3-left">
                        	<h6><strong>Some features of our Money Transfer System are -</strong></h6>
                        	<ul>
                            	<li><p>Non-KYC Customer transaction Limit: Rs 50,000/- per month.</p></li>
                                ...
                                <li><p>Feature of account verification for most of the banks.</p></li>
                                <li><p>Send up to 25000 in one transaction. No need to do multiple transactions of Rs 5000 for higher amounts.</p></li>
                                <li><p>Automatic reconciliation for pending transactions.</p></li>
                                <li><p>Support for both IMPS and NEFT transactions.</p></li>
                                <li><p>High success ratio.</p></li>
                                <li><p>Support for bill payments of credit cards using NEFT.</p></li>
                                <li><p>Quick Add Sender & Receiver via web application or mobile application.</p></li>
                                <li><p>Switching mode IMPS & NEFT.</p></li>
                                <li><p>IFSC Finding Tool.</p></li>
                            </ul>
