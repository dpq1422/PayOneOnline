...
from bankatyf_child1_1001_txn.txn_mt_child where source=1 and type=1 and order_id>75000 and txn_id not in(select txn_id from bankatyf_child1_1001_txn.extra_charges) group by txn_id having chargess > charged; ";
