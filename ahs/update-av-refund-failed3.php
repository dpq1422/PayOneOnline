...
$min_record=0;
$min_query="SELECT * FROM $bankapi_parent_txn.txn_mt where mmt_status in(1,3) and source=3 and type=2 order by mmt_id desc limit 0,1";
...
$qry_av_refund="SELECT * FROM $bankapi_parent_txn.txn_mt where source=3 and type=2 and mmt_status='4' and mmt_id>75000 order by mmt_id desc;";
