...
$qry_mt_tid="SELECT * FROM $bankapi_parent_txn.txn_mt where source=1 and type=1 and response is not null and response!='' and (tid='0' or tid='' or tid is null) and mmt_id>75000 order by mmt_id desc;";//58292
