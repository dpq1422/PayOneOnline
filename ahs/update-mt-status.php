...
$responded_query="update $bankapi_parent_txn.txn_mt set mmt_status='-1' where mmt_status in(1,3) and response like '%$responded_result%' and type=1 and mmt_id>75000;";//58292
mysql_query($responded_query);

$qry_mt_status="SELECT * FROM $bankapi_parent_txn.txn_mt where mmt_status in(1,3) and source=1 and type=1 and mmt_id>75000 order by mmt_id desc;";
