                                        ...
                                        <div class="form">
                                            ...
                                            <div class="form-horizontal">
                                                <div class="form-group ">
                                                    <label class="control-label col-md-3" for="name">Provider</label>
                                                    <div class="col-md-9">
                                                        <select name="dthop" id="dthop" class="form-control">
															<option value="0">Select Operator</option>
                                                ...
                                                <!-- Name -->
                                                <div class="form-group">
                                                    <label class="control-label col-md-3" for="name">DTH Number</label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="dthno" name="dthno">
                                                    </div>
                                                </div>
                                                <!-- Website -->
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <!-- Buttons -->
                                                    <div class="col-md-9 col-md-offset-3">
                                                        <div class="button"><input type="submit" name="dthrecharge" id="dthrecharge" value="Submit"/></div>
...
if (isset($_POST['recharge']))
	{
		...
		include("db-conn.php");
		$bal=0;
		$qry="select bal_amt from wallet_data where user_id='$userid' order by wallet_id desc limit 0,1";
		...
		if($bal>=$amount)
		{
			...
			(NULL,sysdate(),'$mob_no','$userid','1','$operator','0','0','$bal','$amount','0','$amount','$new_bal','0','0','0',sysdate(),sysdate(),sysdate(),'1','0');";
			mysql_query($qry);
...
if (isset($_POST['dthrecharge']))
	{
		$dthno=$_POST['dthno'];
		$operator=$_POST['dthop'];
		$amount=$_POST['amt'];
		$userid=$sess_eml;
		//$dateofbirth=$_POST['dateofbirth'];
		//$dateofbirth=date_format($dateofbirth,"Y-m-d");
		...
		{
			$new_bal=$bal-$amount;
			echo $qry="insert into txn_data value 
			(NULL,sysdate(),'$dthno','$userid','2','$operator','0','0','$bal','$amount','0','$amount','$new_bal','0','0','0',sysdate(),sysdate(),sysdate(),'1','0');";
			mysql_query($qry);
			$txn_id=mysql_insert_id();
			
			$qry="insert into wallet_data value 
			(NULL,curdate(),curtime(),'$userid','Recharge Generated: Order no $txn_id',2,0,'$amount','$new_bal','Recharge Generated: Order no $txn_id');";
			mysql_query($qry);
