...
var ThemeSettings = {
    init: function () {
        this.defineUI(), this.restoreCookieSettings(), this.bindUIEvents(), -1 == this.hash.indexOf("disable-iframe") ? this.loadIframe() : this.window.hide()
    },
    defineUI: function () {
        $.extend(this, {
            constants: {
...
$(window).on("load", function () {
    //window.disableThemeSettings !== !0 ? $("body").append($("<div/>").load(("undefined" != typeof angular ? "../" : "") + "templates/themeSettings.html", function () {
    //    ThemeSettings.init()
        ...
        function c(a, b, c) {
            ...
            if (e.files.length > 0) {
                ...
                $.each(e.files, function (a, b) {
                    -1 != ["image/jpeg", "image/jpg", "image/png", "image/gif"].indexOf(b.type) && h.push(b)
        ...
        var b = {
            init: function (b) {
                ...
                return b = a.extend(c, b), this.each(function () {
                    ...
                    var n, o, p, q, r, s, t, u, v, w, x, z, A, B, C, D, E, F = a(this);
                    return F.hasClass("initialized") ? !0 : (b.full_width && (b.dist = 0, imageHeight = F.find(".carousel-item-gallery img").first().load(function () {
                        F.css("height", a(this).height())
                ...
                if (c.hasClass("autocomplete")) {
                    ...
                    f += "</ul>", e.append(f), a(document).on("keyup", c, function () {
                        ...
                        e.css("width", c.width()), "" != d ? (e.children("li").addClass("hide"), e.children("li").filter(function () {
                            ...
                            return f ? -1 !== a(this).text().toLowerCase().indexOf(d.toLowerCase()) : !1
