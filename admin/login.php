                ...
                <div class="col-md-12">
                    ...
                    <div class="tabbable tabs-left">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active" style="background-image: none; padding: 0px;"><a href="#tab1" data-toggle="tab">Admin Login</a></li>
                            <li style="background-image: none; padding: 0px;"><a href="#tab3" data-toggle="tab">Create User</a></li>
							<li style="background-image: none; padding: 0px;"><a href="#tab2" data-toggle="tab">Forgot Password</a></li>
                        </ul>
...
if (isset($_POST['login']))
	{
		...
		$pw=md5($pw);
		$check=0;
		echo $qry="select * from emp_data where e_mail='$eml' and pass_code='$pw';";
