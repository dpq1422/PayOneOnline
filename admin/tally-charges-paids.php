						...
						<div class="col-md-12">
							<div class="col-md-12">
								<div class="panel panel-primary">
									...
									<?php
										$max_req=0;
										$max_qry="select max(wallet_id) reqid from child_bank_charges_paid";
										...
										$pull_data="insert into child_bank_charges_paid(wallet_id, wallet_date, wallet_time, user_id, user_id2, transaction_description, amount) SELECT wallet_id, wallet_date, wallet_time, user_id, user_id2, transaction_description, amount_cr FROM child_wallet_remain WHERE transaction_type = 13 and wallet_id>$max_req ";
										...
										{
											$t2=$_POST['t2'];
											echo "<script>window.location.href = 'tally-charges-paids.php?rdts=$t2';</script>";
										}
										...
										$cond=" order by wallet_id limit 0,100 ";
										$dts="";
										if($t1!="")
											$cond=" and user_id='$t1' ";
										...
										if($t2!="")
										{
											$cond=" and wallet_date = '$t2' order by wallet_id";
									...
									<div class="panel-body panel-primary text-center">
										<table class="table clsgrid rounded_corners" cellspacing="0" rules="all" border="1" id="ctl00_ContentPlaceHolder1_tagcost" style="width:100%;border-collapse:collapse;font-family:Calibri;font-weight:500;">
											<tbody>
												...
												$query="SELECT * FROM child_bank_charges_paid where 1=1 $cond ";
