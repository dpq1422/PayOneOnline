									...
									<div class="panel-body panel-primary text-center">
										<table class="table clsgrid rounded_corners" cellspacing="0" rules="all" border="1" id="ctl00_ContentPlaceHolder1_tagcost" style="width:100%;border-collapse:collapse;font-family:Calibri;font-weight:500;">
											<tbody>
												...
												//mysql_query($qry);
												$query="SELECT * FROM main_transaction_mt where TIMESTAMPDIFF(SECOND, created_on, '$datetime_time')>30 and eko_transaction_id!=51264 and eko_transaction_status not in(-1,2,5) and source=1 and type=1 $cond order by eko_transaction_id desc";
												...
												<tr style="background-color:White;">
													...
													<td>
														...
														<?php 
														if($source==1 && $rs['type']==1)
														{
														?>
														<br><br><a style='color:green;' href="admin-check-order-status-for-refund.php?oid=<?php echo $rs['eko_transaction_id'];?>">Re-Check</a>
														<?php 
														}
														?>
													</td>
													...
													<td title='<?php echo $abc;?>'><?php echo $rs['created_on']."<br><br>".$rs['updated_on'];?></td>
												</tr>
												<?php
													}
												}
