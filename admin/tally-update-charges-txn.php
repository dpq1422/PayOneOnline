								...
								<div class="panel panel-primary">
									...
									<div class="panel-body panel-primary text-center">
										...
										if(isset($_POST['update']))
										{
											...
											mysql_query($q1);
											$q1="update child_bank_records set request_id='$rid', user_id='$cid', auth_id='$user_id' where bnk_id='$bid2';";
											mysql_query($q1);
											$q2="update child_bank_charges_paid set bnk_id='$bid' where wallet_id='$rid';";
											mysql_query($q2);
											echo "<script>window.location.href = 'tally-charges-paids.php?rdts=$rdts';</script>";
										}
										?>
										<form method="post">
											...
											<table>
												...
												<tr>
													<td align="left" width="150">Charges Paid ID</td>
												...
												<tr>
													...
													<td align="left"></td>
													<td align="left">
														<input required name="bid" id="bid" />&nbsp;&nbsp;
														<input required name="bid2" id="bid2" placeholder="type 0 for CDM" />
													</td>
												</tr>
												<tr><td colspan="3">&nbsp;</td></tr>
												<tr>
