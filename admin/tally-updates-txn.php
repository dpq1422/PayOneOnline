								...
								<div class="panel panel-primary">
									...
									<div class="panel-body panel-primary text-center">
										...
										if(isset($_POST['update']))
										{
											...
											mysql_query($q1);
											$q2="update child_bank_source_requests set bnk_id='$bid' where request_id='$rid';";
											mysql_query($q2);
											echo "<script>window.location.href = 'tally-source-requests.php?rdts=$rdts';</script>";
										}
										?>
										<form method="post">
											...
											<table>
												...
												<tr>
													<td align="left" width="150">Request ID</td>
