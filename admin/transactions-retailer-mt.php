									...
									<div class="panel-body panel-primary text-center">
										<table class="table clsgrid rounded_corners" cellspacing="0" rules="all" border="1" id="ctl00_ContentPlaceHolder1_tagcost" style="width:100%;border-collapse:collapse;font-family:Calibri;font-weight:500;">
											<tbody>
												...
												<?php
												$query="SELECT * FROM child_wallet_remain where request_id!=0 $cond and transaction_type in(6,7) and transaction_description not like 'RC order %' order by wallet_id desc limit 0,100";
												...
												<tr style="background-color:White;">
													...
													<td><?php echo $rs['request_id']."<br>(".$grp.")<br>".$tid;?></td>
													<td><?php echo $uuiidd;?><br><br><?php echo show_my_uname($uuiidd);?></td>
													<td><?php echo $ttype."<br>".$tp."<br>".$bnk;?></td>
