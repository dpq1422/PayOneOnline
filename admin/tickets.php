							...
							<div class="col-md-12">
								<div class="panel panel-primary">
									...
									<?php
										...
										$cond="";
										if($t1!="")
											$cond=" and (ticket_id='$t1' or user_id='$t1') ";
									?>
										<form method="post">
										Search by 
										<input size="30" name="t1" required value="<?php echo $t1;?>" placeholder="Ticket ID / User ID"/>
									...
									<div class="panel-body panel-primary text-center">
										<table class="table clsgrid rounded_corners" cellspacing="0" rules="all" border="1" id="ctl00_ContentPlaceHolder1_tagcost" style="width:100%;border-collapse:collapse;font-family:Calibri;font-weight:500;">
											<tbody>
												...
												<?php
												$query="SELECT * FROM child_tickets where 1=1 $cond order by ticket_id desc limit 0,100";
												...
												if($num_rows>0)
												{
													...
													while($rs = mysql_fetch_assoc($result))
													{
														...
														if($tstatus==1)
														$tstatus="<b style='color:red;'>Opened</b>";
														else if($tstatus==2)
														$tstatus="<b style='color:blue;'>In-Progress</b>";
														else if($tstatus==3)
														$tstatus="<b style='color:red;'>Re-Opened</b>";
														else if($tstatus==4)
														$tstatus="<b style='color:green;'>Closed</b>";
												?>
