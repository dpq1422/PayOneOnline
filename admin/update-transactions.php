...
$query="SELECT * FROM main_transaction_mt where (response is NULL or response='' or tid='') and eko_transaction_status in(1,3,4) and source=1 and type=1 order by eko_transaction_id asc";// and channel=2
...
$qry1="select * from main_transaction_mt where eko_transaction_status in(1,3) and source=1 and type=1 and channel=2 and refund_cid=0 order by eko_transaction_id desc;";// and channel=2
...
echo $statement="<br><br><b>Order No :</b> $oid ($chdesc), <b>User Id :</b> $uid, <b>User Name :</b> $unm, <b>Date :</b> $dts, <b>Amount :</b> $amtpr, <br><b>TxnNo :</b> $tid, <b>Updated Status :</b> $txsts, <b>Bank :</b> $rbname";
//, <b>Charges :</b> $com_charged";
