					...
					<div class="row">
							...
							<div class="col-md-12">
								<div class="panel panel-primary">
									...
									<?php 
										...
										$query="SELECT * FROM child_user where user_type in(2,3,11) and hierarchy_1_no=1 and hierarchy_2_no=0 and hierarchy_3_no=0 and hierarchy_1_id=100001 and hierarchy_2_id=0 and hierarchy_3_id=0 $cond order by user_type,user_name";
						...
						else
						{
							$collection="<b style='font-size:20px;'>$collection</b>";
											...
											$total2+=$earning=show_my_earning($rs['user_id'],$t2);
											$earning="<b style='font-size:20px;'>$earning</b>";
									?>
												<tr <?php echo $style;?>>
													<td><?php echo $i;?></td>
