					...
					<div class="row">
						<div class="col-md-12">
							<div class="col-md-12">
									...
									<div class="panel-body panel-primary text-center">
										<table class="table clsgrid rounded_corners" cellspacing="0" rules="all" border="1" id="ctl00_ContentPlaceHolder1_tagcost" style="width:100%;border-collapse:collapse;font-family:Calibri;font-weight:500;">
											<tbody>
												...
												$query="SELECT * FROM child_bank_records where 1=1 $cond ";
											...
											<tr <?php echo $style;?>>
												...
												<td><?php echo $desc;?></td>
												<td align='right'><?php echo $txn_cr;?></td>
												<td align='right'><?php echo $txn_dr;?></td>
												<td align='right'><?php echo $txn_bal;?></td>
								<?php
								if(($rs['request_id']!=0 || $rs['user_id']!=0 || $rs['auth_id']!=0) || $txn_dr!=0)
								{
								?>
								...
								{
								?>
												<td colspan='3'><a href="tally-update-txns.php?bnk=<?php echo $rs['bnk_id'];?>&rdts=<?php echo $rs['bnk_date'];?>">Update</a></td>
								<?php
								}												
								?>
											</tr>
