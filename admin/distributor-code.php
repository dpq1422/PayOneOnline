...
if($result4==1)
{
	...
	if($HierarchyName==2)
	header("location:set-mt-margins.php?uid=$last_id");
	else if($HierarchyName==3)
	header("location:set-mt-margind.php?uid=$last_id");
}
else
header("location:distributor.php?msg=distributor-registration-fail");
