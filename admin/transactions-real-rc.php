									...
									<div class="panel-body panel-primary text-center">
										<table class="table clsgrid rounded_corners" cellspacing="0" rules="all" border="1" id="ctl00_ContentPlaceHolder1_tagcost" style="width:100%;border-collapse:collapse;font-family:Calibri;font-weight:500;">
											<tbody>
												...
												<?php
												$query="SELECT * FROM child_wallet_realtime where client_order_id!=0 $cond and transaction_description like 'RC order %' order by wallet_id desc limit 0,100";
												...
												if($num_rows>0)
												{
													...
													while($rs = mysql_fetch_assoc($result))
													{
														...
														else if($st==2)
														{
															if($refno!="" && $refno!=0)
															{
																$st="<b style='color:green;'>Success<br>Ref No: $refno</b>";
															}
															else
															{
															...
															$st="<b style='color:red;'>Initiated</b>";
														else 
												...
												<tr style="background-color:White;">
													...
													<td><?php echo $rs['client_order_id']."<br>(".$grp.")<br>";?></td>
													<td><?php echo $uuiidd;?><br><br><?php echo show_my_uname($uuiidd);?></td>
													<td><?php echo $ttype;?></td>
													<td><?php echo $rs['transaction_description']."<br>$st";?></td>
