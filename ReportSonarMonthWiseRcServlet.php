            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						...
						$total_records=md3_count();
						$result_md=md3_show();
						$qr="&s1=$s1&s2=$s2&s3=$s3&s4=$s4&s5=$s5&search=search";
						$i=0;
						?>
                    	<div class="box-head">
                        	<h3>SONAR REPORT MONTH WISE (Prepaid Mobile Recharge / DTH Recharge) <span class="w3-right w3-blue w3-center badges"><?php echo $total_records;?></span></h3>
                        </div>
                        <div class="w3-responsive">
                        	<table class="w3-table-all" id="myTable" style="border:none;">
								...
								{
									$a+=$rs_rd['recharge_unit'];
									$b+=$rs_rd['recharge_amount'];
									$c+=$rs_rd['recharge_deducted'];
									$d+=$rs_rd['noti'];
									$e+=$rs_rd['succ'];
									$f+=$rs_rd['inpro'];
									$g+=$rs_rd['rpsrc'];
