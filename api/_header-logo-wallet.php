                        ...
                        <div class="header-main-right w3-right">
                            <div class="header-main-right-top wh w3-right">
                                <div class="wh w3-right w3-right-align">
                                    <span><a ><img src="img/refresh-icon.png" onclick="window.location.reload();" class="refresh w3-right-align"></a>Wallet Admin : <strong>1234</strong></span>
                                </div>
                                <div class="wh w3-right w3-right-align">
                                    <span>Distribution : <strong>123</strong></span>
                                </div>
                            </div>
                            <div class="header-main-right-bott wh w3-right">
                                <ul class="welcome-txt">
                                    <li>Welcome : <a href="MyProfileServlet">User Name (Designation)</a></li>
									<!--
