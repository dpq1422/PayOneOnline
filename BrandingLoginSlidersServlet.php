            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
						<?php
						include_once('zf-Branding-Login.php');
						/**************************/
						$num_rec_per_page=8;
						...
						$total_records=show_loginsliders_count($cond);
						$loginslider_result=show_loginsliders_data($cond, $start_from, $num_rec_per_page);
						$qr="";//"&s1=$s1&s2=$s2&s3=$s3&s4=$s4&search=search";
						$i=0;
						?>
                    	<div class="box-head">
                        	<h3>List of Login Sliders for Branding <span class="w3-right w3-blue w3-center badges"><?php echo $total_records;?></span></h3>
                        </div>
                        <div class="table-div wh w3-left">
                        	<ul>
								...
								<?php
								while($loginslider_row=mysql_fetch_array($loginslider_result))
								{
									$i++;			
									
									$loginslider_status=$loginslider_row['slider_status'];
									$st_link="";
									if($loginslider_status==1)
									{
										$loginslider_status="<b class='w3-text-green'>Active</b>";
										$st_link="<button class='w3-button w3-red w3-round'>Mark As Block</button>";
									}
									else if($loginslider_status==0)
									{
										$loginslider_status="<b class='w3-text-red'>Blocked</b>";
										$st_link="<button class='w3-button w3-green w3-round'>Mark As Active</button>";
									}
								?>
                                <li>
                                	<span><?php echo $loginslider_row['slider_id'];?></span>
                                    <span><?php echo $loginslider_row['slider_name'];?></span>
                                    <span><?php echo $loginslider_row['slider_file'];?></span>
                                    <span><?php echo $loginslider_row['from_date'];?></span>
                                    <span><?php echo $loginslider_row['from_to'];?></span>
                                    <span><?php echo $loginslider_status;?></span>
