...
$query="SELECT distinct(city_name) city FROM bankatyf_ifsc.all_bank_data where bank_code='$bank2state' and state_name='$state2dist' and distt_name='$dist2city' order by city_name";
