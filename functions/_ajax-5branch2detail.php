...
$query="SELECT * FROM bankatyf_ifsc.all_bank_data where bank_code='$bank2state' and state_name='$state2dist' and distt_name='$dist2city' and city_name='$city2branch' and branch_name='$branch2detail'";
