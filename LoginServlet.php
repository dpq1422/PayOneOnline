...
<meta name="description"  content="PayOne Online provides you best price/commission Money Transfer API, Prepaid Mobile Recharge API, Airline Ticketing API, Hotel Reservation API, Bus Ticketing API, Railway Ticketing API, mPOS, Postpaid Mobile Bill Payment API, DTH Recharge API, Electricity Bill Payment API." />
