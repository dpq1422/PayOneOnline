...
<title>Flight Booking :: <?php echo $site_link;?></title>
            ...
            <div class="w3-row-padding">
                <div class="w3-col l3 m3 w3-padding-16">
                    <div class="left-menu wh w3-left">
                    	...
                    	<ul>
							...
							<li><a href="mpos-devices.php">mPOS / POS Devices</a></li>
							<li><a href="prepaid-cards.php">Prepaid Cards</a></li>
							<li><a class="active-arrow" href="flight-booking.php">Flight Booking</a></li>
							<li><a href="railway-reservation.php">Railway Reservation</a></li>
							<li><a href="bus.php">Bus Booking</a></li>
                        </ul>
                    </div>
                ...
                <div class="w3-col l9 m9 w3-padding-16">
                    <div class="right-contact wh w3-left show-tab">
                    	...
                    	<h2 class="w3-text-deep-orange">Flight Booking</h2>
						<img src="img/comming-soon.png" class="w3-pad" height="150" align="right" />
                        <p class="w3-margin-top w3-justify">
We support all major airlines for domestic as well as international flight ticket bookings. With our platform, No investment is required for open your own flight booking agency, just search, book and done! 
Get high commissions on each flight booking.
</p>
						<div class="money-feature w3-margin-top wh w3-left">
						    <p>
                                <script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
                        ...
                        <div class="money-feature w3-margin-top wh w3-left">
                        	<h6><strong>Some features of our flight booking service are -</strong></h6>
                        	<ul>
                            	<li><p>Cheapest rates of all flights - domestic and international.</p></li>
                                <li><p>Special Coupon fares available for selected airlines.</p></li>
                                <li><p>Email & SMS Alerts to customers on ticket booking.</p></li>
                                <li><p>You can add meals and baggage while entering passenger details.</p></li>
                                <li><p>Standard filters to search in flights.</p></li>
