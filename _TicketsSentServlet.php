            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
                    	<div class="box-head">
                        	<h3>LIST OF TICKETS (SENT) <span class="w3-right w3-blue w3-center badges">122</span><a href="TicketSendNewServlet" class="add-new w3-right w3-green w3-center badges">Generate New Ticket</a></h3>
                        </div>
                        	...
                        	<ul>
                                ...
                                <li>
                                	<div class="address inner-add wh w3-left">
                                        <p><strong>REMARKS:-</strong>Neel giri apartment, Fortview Road Opposite JK Hospital, Near Arti Petrol Pump</p>
                                        <p><strong>RESOLUTION:-</strong> ABC@gmail.com</p>
                                        <p><strong>LAST UPDATED BY:-</strong>1234567890</p>
                                        <div class="w3-bar w3-right-align">
                                            <button onclick="location.href='TicketSentReplyServlet';" class="w3-button w3-blue w3-round">REPLY</button>
                                        </div>
                                    </div>
                                </li>
                                <li>
