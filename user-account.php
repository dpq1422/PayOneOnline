...
if(!isset($_SESSION['eml']))
	...
	$qry="select * from user_reg where e_mail='$sess_eml';";
	$result=mysql_query($qry);
	while($rs=mysql_fetch_array($result))
	{
		$sess_username=$rs['user_name'];
                ...
                <div class="col-md-12">
                    ...
                    <div class="tabbable tabs-left">
                        ...
                        <ul class="nav nav-tabs">
							...
							<li style="background-image: none; padding: 0px;"><a href="#tab6" data-toggle="tab">Add Wallet Balance</a></li>
										...
										<div class="form">
                                            ...
                                            <div class="form-horizontal form-horizontals">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" readonly class="form-control"  id="user_name" name="user_name" value="<?php echo $sess_username;?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="cwell" style="padding-top: 10px;">
                                        ...
                                        <table width="100%" class='mytable' cellpadding='0' cellspacing='0'>
											...
											<?php 
											include("db-conn.php");
											$qry="select * from wallet_data where user_id='$sess_eml' order by wallet_id desc limit 0,20;";
											$result=mysql_query($qry);
											while($rs=mysql_fetch_array($result))
											{
											?>
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="cwell" style="padding-top: 10px;">
                                        ...
                                        <table width="100%" class='mytable' cellpadding='0' cellspacing='0'>
											...
											<?php 
											include("db-conn.php");
											$qry="select * from txn_data where user_id='$sess_eml' order by txn_id desc limit 0,20;";
											$result=mysql_query($qry);
											while($rs=mysql_fetch_array($result))
											{
											?>
                                    ...
                                    <div class="cwell" style="padding-top: 10px;">
                                        ...
                                        <div class="form">
                                            ...
                                            <div class="form-horizontal">
                                                <!-- Name -->
                                                <div class="form-group">
                                                    <label class="control-label col-md-3" for="name" >Complaint Type<span class="reqrd">*</span></label>
                                                    <div class="col-md-9">
                                                        <select name="ctype" id="ctype" class="form-control">
															<option value="">Select Type</option>
															<option>Amount deducted but no recharge</option>
															<option>Recharge failed but amount not refunded</option>
															<option>Recharge is pending</option>
														</select>
                                                    </div>
                                                </div>
												<div class="form-group">
                                                    <label class="control-label col-md-3" for="name" >Transaction Id</label>
                                                    <div class="col-md-9">
													<input type="text" class="form-control" id="trans_id" name="trans_id">
                                                    </div>
                                                </div>
												<div class="form-group">
                                                    <label class="control-label col-md-3" for="name" >Complaint Description</label>
                                                    <div class="col-md-9">
													<textarea rows="3" cols="50" class="form-control" id="comp_desc" name="comp_desc"></textarea>
                                                    </div>
                                                </div>
                                                <!-- Buttons -->
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-md-offset-3">
                                                        <div class="button"><input type="submit" value=" Submit Complaint" name="comp" id="comp"> </div>
                                        ...
                                        <table width="100%" class='mytable' cellpadding='0' cellspacing='0'>
											...
											<?php 
											include("db-conn.php");
											$qry="select * from complaint_data where user_id='$sess_eml' order by txn_id desc limit 0,20;";
											$result=mysql_query($qry);
											while($rs=mysql_fetch_array($result))
											{
											?>
										...
										<div class="form">
                                            ...
                                            <div class="form-horizontal form-horizontals">
												...
												<div class="form-group">
                                                    <!-- Buttons -->
                                                    <div class="col-md-9 col-md-offset-3">
                                                        <div class="button"><input type="submit" name="amt" id="amt" value="Add Balance"/></div>
...
if (isset($_POST['update']))
	{
		...
		echo $qry="update user_reg set full_name='$full_name',gender='$gender',address='$address',city='$city' where e_mail='$e_mail';";
		mysql_query($qry);
...
if (isset($_POST['ch_pass']))
	{
		...
		//$dateofbirth=$_POST['dateofbirth'];
		//$dateofbirth=date_format($dateofbirth,"Y-m-d");
		echo $qry="update user_reg set pass_code='$newpass' where e_mail='$eml' and pass_code='$oldpass';";
		mysql_query($qry);
		$result=mysql_affected_rows();
		echo "<script>window.location.href='user-account.php';</script>";
	}
...
if (isset($_POST['amt']))
	{
		...
		$qry="select bal_amt from wallet_data where user_id='$e_mail' order by wallet_id desc limit 0,1";
		$result=mysql_query($qry);
		while($rs=mysql_fetch_array($result))
		{
			$bal=$rs['bal_amt'];
		...
		(NULL,curdate(),curtime(),'$e_mail','Balance Added',1,'$amount',0,'$new_bal','Balance Added');";
		mysql_query($qry);
		$result=mysql_affected_rows();
		echo "<script>window.location.href='user-account.php';</script>";
		if($result>0)
