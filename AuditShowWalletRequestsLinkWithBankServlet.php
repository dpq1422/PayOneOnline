            ...
            <div class="w3-row-padding w3-margin-top">
            	<div class="w3-col m12 wow bounceIn">
                	<div class="table-box wh w3-left">
                    	<div class="box-head">
                        	<h3>AUDIT LINK WALLET REQUEST WITH BANK TXN CREDIT RECORD</h3>
                        </div>
                        <form class="wh w3-left">
                        	<div class="w3-row-padding w3-margin-bottom">    	
                            	<div class="w3-col m6 l4 w3-margin-top">
                                	<label>REQUEST ID</label>	
                                	<input type="text" placeholder="REQUEST ID" class="w3-input w3-border w3-round" disabled>                                    
                                </div>  
                                
                                <div class="w3-col m6 l4 w3-margin-top">
                                	<label>USER ID</label>
                                	<input type="text" placeholder="USER ID" class="w3-input w3-border w3-round" disabled>                                    
                                </div>
                                
                                <div class="w3-col m6 l4 w3-margin-top">
                                	<label>BANK REF NO</label>
                                	<input type="text" placeholder="BANK REF NO" class="w3-input w3-border w3-round">                                    
                                </div>
      ...
      <div class="w3-container w3-center">
        ...
        <div class="w3-container" style="margin-bottom:10px;">
            <div class="w3-bar w3-center">
                <a href="AuditShowWalletRequestsServlet" class="w3-button w3-blue w3-round">Yes</a>
