                        ...
                        <div class="table-div wh w3-left">
                        	<ul>
								...
								while($level_row=mysql_fetch_array($level_result))
								{
									...
									if($level_type==1)
										$level_type="<b class='w3-text-green'>Main Admin</b>";
									else if($level_type==2)
										$level_type="Team Member";
									else if($level_type==3)
										$level_type="<b class='w3-text-green'>Retailer</b>";
									else if($level_type==4)
										$level_type="Affiliate Partner";
									
									$level_status=$level_row['level_status'];
									$st_link="";
									if($level_status==1)
									{
										$level_status="<b class='w3-text-green'>Active</b>";
										$st_link="<button class='w3-button w3-red w3-round'>Mark As Block</button>";
									}
									else if($level_status==0)
									{
										$level_status="<b class='w3-text-red'>Blocked</b>";
